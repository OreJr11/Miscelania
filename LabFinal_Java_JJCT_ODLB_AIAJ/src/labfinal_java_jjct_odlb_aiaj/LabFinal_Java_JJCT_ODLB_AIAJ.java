                    ...
                    while (p1 == 0 | p2 == 0 | p3 == 0 | p4 == 0 | p5 == 0 | p6 == 0 | p7 == 0 | p8 == 0 | p9 == 0) {
                        switch (op) { // Switch con 9 opciones, una por cada ficha
                            case 1:
                                ...
                                if (p1 == 0) {
                                    ...
                                    JOptionPane.showMessageDialog(null, "¿Desea retirar una segunda ficha contigua?\n1. Si (Presione cualquier otro número para No)");
                                    ...
                                    if (op == 1) {
                                        while (val == 0) { // Bucle que valida cada posible situación
                                            ...
                                            if (p4 != 0 & p2 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 4 o 2?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 4 & fc != 2) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                }
                                                if (fc == 4) {
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p3 != 0 & p1 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 3 o 1?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 3 & fc != 1) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p5 != 0 & p2 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 5 o 2?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 5 & fc != 2) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p6 != 0 & p1 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 6 o 1?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 6 & fc != 1) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p7 != 0 & p3 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 7 o 3?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 7 & fc != 3) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p8 != 0 & p4 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 8 o 4?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 8 & fc != 4) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p9 != 0 & p5 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 9 o 5?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 9 & fc != 5) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p9 != 0 & p6 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 9 o 6?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 9 & fc != 6) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                    ...
                                    if (op == 1) {
                                        while (val == 0) {
                                            if (p8 != 0 & p7 != 0) {
                                                ...
                                                JOptionPane.showMessageDialog(null, "¿Qué ficha desea retirar, 8 o 7?");
                                                fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                                                while (fc != 8 & fc != 7) {
                                                    JOptionPane.showMessageDialog(null, "✺✺Ficha inválida, digite nuevamente✺✺");
                                                    fc = Integer.parseInt(JOptionPane.showInputDialog("➥➥"));
                        ...
                        if (p1 == 0 || p2 == 0 || p3 == 0 || p4 == 0 || p5 == 0 || p6 == 0 || p7 == 0 || p8 == 0 || p9 == 0) {
                            ...
                            if (td == 0) {
                                ...
                                JOptionPane.showMessageDialog(null, "Ficha inválida, elija otra posición");
